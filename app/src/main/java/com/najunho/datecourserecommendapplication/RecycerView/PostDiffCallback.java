...
public class PostDiffCallback extends DiffUtil.ItemCallback<Post>{
    ...
    public Object getChangePayload(@NonNull Post oldItem, @NonNull Post newItem) {
        ...
        if (!Objects.equals(oldItem.getTitle(), newItem.getTitle())) diff.putBoolean("title", true);
        if (!Objects.equals(oldItem.getPreviewText(), newItem.getPreviewText())) diff.putBoolean("previewText", true);
