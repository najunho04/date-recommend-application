...
import com.najunho.datecourserecommendapplication.Util.ItemTouchHelperListener;
...
public class ContentAdapter extends ListAdapter<Content, ContentAdapter.ContentViewHolder>
    ...
    public class ContentViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvLocation;
        ImageView imgPreview, imgLoading;
        ...
        public void bind(Content item) {
            ...
            if (item.getIsCore()){
                btnIsCore.setImageResource(R.drawable.is_core_true_32px);
            }else {
                btnIsCore.setImageResource(R.drawable.is_core_32px);
            }
